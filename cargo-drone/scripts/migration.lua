...
local patches = {
    ...
    {
        mod_state = 15,
        apply = create_apply_patch("migration.15")
    },
    {
        mod_state = 16,
        apply = create_apply_patch("migration.16")
    },
    {
        mod_state = 17,
        apply = create_apply_patch("migration.17")
    },
    {
        mod_state = 18,
        apply = create_apply_patch("migration.18")
    },
    {
        mod_state = 19,
        apply = create_apply_patch("migration.19")
    },
    {
        mod_state = 20,
