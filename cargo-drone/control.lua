...
function on_surface_deleted(event)
	...
	mc.surface_deleted(event.surface_index)
	mh.surface_deleted(event.surface_index)
end
function on_surface_cleared(event)
	...
	mc.surface_cleared(event.surface_index)
	mh.surface_cleared(event.surface_index)
end
